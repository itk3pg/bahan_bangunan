<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <?php } ?>
            <?php if($this->session->userdata('group_kode') == "GRU0000" || $this->session->userdata('group_kode') == "GRU0003" || $this->session->userdata('group_kode') == "GRU0004" || $this->session->userdata('group_kode') == "GRU0005" || $this->session->userdata('group_kode') == "GRU0006" || $this->session->userdata('group_kode') == "GRU0008" || $this->session->userdata('group_kode') == "GRU0009" || $this->session->userdata('group_kode') == "GRU0010" || $this->session->userdata('group_kode') == "GRU0011" || $this->session->userdata('group_kode') == "GRU0012" || $this->session->userdata('group_kode') == "GRU0007"){ ?>
            <li id="konsinyasi">
